...
app.layout = html.Div(id="body", className="e5_body", children=[
    html.A(href="https://github.com/genagithub/proyecto-5/blob/main/README.md", children=[html.H1("Estimación de Uplift mediante enfoque de Bundling", id="title", className="e5_title")]),
    html.Div(id="container_1", className="e5_container_1",children=[
        html.Div(id="dropdown_div", className="e5_dropdown_div", style={"margin-left":"65px"}, children=[
        ...
        html.Div(id="div",className="e5_div",style={"justify-content":"space-around"},children=[
